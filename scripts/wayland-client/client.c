...
draw_frame(struct client_state *state)
{
    ...
    /* Important: use WL_SHM_FORMAT_ARGB8888 that has an alpha channel and NOT WL_SHM_FORMAT_XRGB8888 that does NOT have an alpha channel */
    ...
    /* Fill the buffer with transparent color */
